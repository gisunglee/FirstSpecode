 ...
 *   - 기능의 "구현 공수"(impl_efrt_val), 단위업무의 "계획설계 공수"(plan_dsgn_efrt_val) 양쪽에서
 *     공유 — 각 상세 페이지의 참고 표시와 PM 대시보드(지연 공수 집계)에서 사용. 화면(TbDsScreen)엔
 *     공수 컬럼 자체가 없음(2026-07-28 개편으로 설계공수는 단위업무, 구현공수는 기능 소관)
 */
