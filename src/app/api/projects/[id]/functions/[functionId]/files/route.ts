...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    for (const file of files) {
      ...
      // 물리 경로: functions/{projectId}/{functionId}/{storeName}
      const subPath      = `functions/${projectId}/${functionId}/${storeName}`;
    ...
    console.error(`[POST /api/projects/${projectId}/functions/${functionId}/files] 업로드 오류:`, err);
