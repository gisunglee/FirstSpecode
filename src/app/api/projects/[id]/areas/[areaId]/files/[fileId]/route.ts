/**
 * DELETE /api/projects/[id]/areas/[areaId]/files/[fileId] — 첨부파일 삭제
 * PATCH  /api/projects/[id]/areas/[areaId]/files/[fileId] — req_ref_yn 토글
 */
...
export async function DELETE(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    console.error(`[DELETE /api/projects/${projectId}/areas/${areaId}/files/${fileId}] 오류:`, err);
...
export async function PATCH(request: NextRequest, { params }: RouteParams) {
  ...
  try {
    ...
    console.error(`[PATCH /api/projects/${projectId}/areas/${areaId}/files/${fileId}] 오류:`, err);
