    ...
    await prisma.tbCmReferenceInfo.update({
      ...
      data: isToggle
        ...
        : {
            ...
            ref_end_de:       refEndDe !== undefined ? (refEndDe?.trim() || null) : existing.ref_end_de,
            ...
            main_ref_val:     mainRefVal !== undefined ? (mainRefVal?.trim() || null) : existing.main_ref_val,
            sub_ref_val:      subRefVal !== undefined ? (subRefVal?.trim() || null) : existing.sub_ref_val,
            ref_info_dc:      refInfoDc !== undefined ? (refInfoDc?.trim() || null) : existing.ref_info_dc,
