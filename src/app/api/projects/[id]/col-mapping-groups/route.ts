 ...
 *
 * refType: FUNCTION | AREA | SCREEN (col-mappings 와 동일한 참조 유형)
 *
 * 권한(POST): 대상 엔티티의 수정 권한과 동일 — OWNER/ADMIN·PM/PL·가장 가까운 담당자만.
 */
...
export async function POST(request: NextRequest, { params }: RouteParams) {
  ...
  // 권한: 매핑 그룹은 대상 엔티티(기능 등) 설계 내용의 일부 → 그 엔티티의 수정 권한과 동일하게 판정.
