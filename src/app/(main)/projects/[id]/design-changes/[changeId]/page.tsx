...
const FIELD_LABEL: Record<string, string> = {
  ...
  progrs_rt:            "진척률",
  dsgn_doc_sttus_code:  "설계서 작성 상태",
  // 2026-07-28 스키마 개편 — 레벨별로 이름이 분리됨 (구버전 이력 표시용으로 옛 키도 남겨둠)
  impl_efrt_val:        "구현 공수",
  actl_dsgn_bgng_de:    "실질설계 시작일",
  actl_dsgn_end_de:     "실질설계 종료일",
  actl_dsgn_efrt_val:   "설계 공수",
  actl_impl_bgng_de:    "실질구현 시작일",
  actl_impl_end_de:     "실질구현 종료일",
  plan_dsgn_bgng_de:    "계획설계 시작일",
  plan_dsgn_end_de:     "계획설계 종료일",
  plan_dsgn_efrt_val:   "계획설계 공수",
  anls_bgng_de:         "분석 시작일",
  anls_end_de:          "분석 종료일",
  anls_efrt_val:        "분석 공수",
  // 2026-07-28 이전 이력 레코드가 아직 담고 있는 구버전 키 — 위 신규 키로 대체됐지만
  // 과거 스냅샷 표시가 raw 컬럼명으로 깨지지 않도록 라벨만 유지
  efrt_val:             "공수",
  bgng_de:              "시작일",
  end_de:               "종료일",
  tbl_id:               "테이블 ID",
