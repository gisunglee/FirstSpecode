 ...
 *   - 2026-04-25 D2: areaType 허용값을 단일 CRUD UI 와 일치.
 *   - 2026-05-04: areaType 분류 재정의 — FILTER/LIST/FORM/DETAIL/GENERAL (Gemini 안 채택, 데이터 성격 기준).
...
| 영역 유형 (areaType) | ✅ 권장 | FILTER(조회 조건) / LIST(데이터 목록) / FORM(데이터 양식) / DETAIL(상세 정보) / GENERAL(일반 콘텐츠) |
...
| areaType | \`FILTER\` \| \`LIST\` \| \`FORM\` \| \`DETAIL\` \| \`GENERAL\` |
