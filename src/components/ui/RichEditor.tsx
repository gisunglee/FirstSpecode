      ...
      <div style={expanded ? {
        ...
        {expanded && (
          <div
            ...
            style={{ cursor: panelIsFull ? "default" : "move", userSelect: "none", display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", background: "var(--color-bg-muted)", borderBottom: "1px solid var(--color-border)", flexShrink: 0 }}
          >
