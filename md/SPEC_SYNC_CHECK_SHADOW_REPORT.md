...
> 작성일: 2026-08-17
> 상태: SPECODE 제품 저장소 내부 UW 5개의 계약 회귀용 기준 답안 · 고객 프로젝트 실사용 검증 아님
...
아래 5건은 제품 내부 개발 검토 자료다. 운영 활성화의 실제 고객 사례 수로 계산하지 않는다.
고객 검증은 현재 확인된 `운영시스템 구축(2차) / UW-00011 일정관리`와 격리된 테스트 변형으로
별도 수행한다.
